...
class Kembalian {
    // Fungsi untuk mencari jumlah minimum koin yang dibutuhkan
    public static int minKoin(int jumlah) {
        ...
        // Inisialisasi array dp dengan nilai yang sangat besar
    ...
    public static void main(String[] args) {
        ...
        if (result != -1) {
            ...
            System.out.println("Tidak mungkin untuk mendapatkan jumlah tersebut dengan koin yang tersedia.");
        }
